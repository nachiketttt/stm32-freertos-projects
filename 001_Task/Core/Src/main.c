...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	setvbuf(stdout, NULL, _IONBF, 0);  // disable printf buffering for ITM
  ...
  //for now it returns an error as freeRTOS expects a callback function when there is staack overflow
