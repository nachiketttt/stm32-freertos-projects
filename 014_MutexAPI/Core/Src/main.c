...
static void PrintTask(void* parameters)
{
	char *pStringToPrint;
		...
		/* Two instances of this task are created so the string of the task will send
		to prvNewPrintString() is passed in the task parameter.  Cast this to the
		required type. */
		pStringToPrint = (char*)parameters;

		for( ;; )
		{
			//Print out the string using the newly defined function
			prvNewPrintString(pStringToPrint);
